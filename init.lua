...
-- Quick colorscheme changing
vim.keymap.set('n', '<leader>df', ':colorscheme dayfox<CR>', { desc = 'Change colorscheme to [D]ay[F]ox' })
vim.keymap.set('n', '<leader>nf', ':colorscheme nightfox<CR>', { desc = 'Change colorscheme to [N]ight[F]ox' })

-- Really nice visual block surround shortcut
...
vim.keymap.set('n', 'gn', '<cmd>vs<CR><cmd>lua vim.lsp.buf.definition()<CR>')

-- Diagnostic keymaps
vim.keymap.set('n', '1', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', '2', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
...
vim.keymap.set('n', '<leader>tw', ':sp<CR><C-w>J10<C-w>_:terminal<CR>i', { desc = 'Open [T]erminal [W]ide' })

-- open current buffer
vim.keymap.set('n', '<leader>oo', ':lua vim.ui.open(vim.fn.expand("%"))<cr>', { desc = 'Open file with default program' })

-- overseer
vim.keymap.set('n', '<leader>od', ':OverseerToggle<CR>', { desc = '[O]verseer Toggle' })
vim.keymap.set('n', '<leader>oc', ':OverseerClose<CR>', { desc = '[O]verseer [C]lose' })
